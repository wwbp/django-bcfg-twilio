...
def test_clear_all_prompts_works_only_dev(individual_prompt_factory):
...
def test_clear_all_prompts(individual_prompt_factory):
    ControlConfig.objects.create(key=ControlConfig.ControlConfigKey.PERSONA_PROMPT, value="test_value")
    individual_prompt_factory.create_batch(2)
...
def test_clear_all_prompts_user_does_not_confirm(individual_prompt_factory):
    ControlConfig.objects.create(key=ControlConfig.ControlConfigKey.PERSONA_PROMPT, value="test_value")
    individual_prompt_factory.create_batch(2)
