...
def test_load_instruction_prompt_with_existing_user_and_prompt():
    ...
    user = User.objects.create(id="user1", week_number=3, school_mascot="Hawks", message_type="initial")
    ...
    prompt = Prompt.objects.create(week=3, type="initial", activity="Custom Activity for Week 3")
...
def test_load_instruction_prompt_with_existing_user_no_prompt():
    ...
    """
    user = User.objects.create(id="user2", week_number=2, school_mascot="Lions", message_type="initial")
...
def test_load_instruction_prompt_with_empty_school_mascot():
    ...
    """
    user = User.objects.create(id="user3", week_number=1, school_mascot="", message_type="initial")  # empty mascot
